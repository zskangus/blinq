...
- (CAShapeLayer *)Knob{
    if (!_Knob) {
        ...
        // 绘制圆形\椭圆
        UIBezierPath *Knobpath = [UIBezierPath bezierPathWithOvalInRect:CGRectMake(30, 0, 30, 30)];
...
-(CAShapeLayer *)background{
    ...
    if (!_background) {
        ...
        // 绘制圆角矩形
        UIBezierPath *bgpath = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(3, 4, 55, 22) cornerRadius:10];
